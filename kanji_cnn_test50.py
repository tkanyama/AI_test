...
if __name__ == '__main__':
    ...
    cnts, img, img3 = detect_zipno("手書きサンプル005.tif")
    ...
    jis = jiscode()
    jis_code_file = 'ETL9BJISCODE-50.picle'
    ...
    model=load_model('etl9b_model-50.h5')
    model.load_weights('etl9b_weight-50.h5')
    ...
    for y in y1:
        ...
        s1 = np.argsort(y)[::-1]
        for i in range(10):
            c1 = chr(jis.jis2uni(code_mat[s1[i]]))
            y1 = y[s1[i]]
