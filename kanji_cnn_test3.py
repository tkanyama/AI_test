...
class kanji_find:
    ...
    def kanji_image(self, image_main = None, PLOT_FLAG = False):
        ...
        for i in range(n):
            ...
            # ピーク値のインデックスを取得
            xmaxid2 = signal.argrelmax(xsum, order=10)[0]  # 最大値
...
if __name__ == '__main__':
    ...
    fname = home + '/BOX_IMAGE/手書き文字認識用サンプル2/手書き文字認識用サンプル2_name_1.png'
    image_main = imread(fname)

    kf = kanji_find()
    img, img3, text = kf.kanji_image(image_main, PLOT_FLAG=False)
